...
cmake -D CMAKE_BUILD_TYPE=RELEASE \
            -D CMAKE_INSTALL_PREFIX=$WD/installation/OpenCV-"$cvVersion" \
...
# Fix package config issue
cp $WD/installation/OpenCV-3.4.4/lib/pkgconfig/opencv.pc /usr/share/pkgconfig/
export OpenCV_DIR=$WD/installation/OpenCV-3.4.4/share/OpenCV